...
# MesksTest
#set(downloadLibtorchPath "/public/libtorch")
#set(Torch_DIR "${downloadLibtorchPath}/share/cmake/Torch")
#find_package(Torch REQUIRED)
#file(GLOB MesksLibH "${VTM_LIB_SOURCE_DIR}/MesksLib/MesksLib.h")
#file(GLOB MesksLibCPP "${VTM_LIB_SOURCE_DIR}/MesksLib/MesksLib.cpp")
#add_library(MesksLib ${MesksLibH} ${MesksLibCPP})
#target_link_libraries(MesksLib ${TORCH_LIBRARIES})

find_package(Python REQUIRED COMPONENTS Interpreter Development)    ## Python 3.10.9
find_package(Python REQUIRED COMPONENTS NumPy)                      ## NumPy  1.22.0
include_directories(${Python_NumPy_INCLUDE_DIRS} ${pybind11_INCLUDE_DIRS})
file(GLOB MesksLibH "${VTM_LIB_SOURCE_DIR}/MesksLib/MesksLib.h")
file(GLOB MesksLibCPP "${VTM_LIB_SOURCE_DIR}/MesksLib/MesksLib.cpp")
add_library(MesksLib ${MesksLibH} ${MesksLibCPP})
target_link_libraries(MesksLib Python::Python CommonLib)
# MesksTest 
...
target_link_libraries(EncoderLib_vtm PUBLIC CommonLib MesksLib )
