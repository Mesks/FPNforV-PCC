...
Void TComUpsampleFilter::upsampleBasePic( TComSlice* currSlice, UInt refLayerIdc, TComPicYuv* pcUsPic, TComPicYuv* pcBasePic, TComPicYuv* pcTempPic, const Int refBitDepthLuma, const Int refBitDepthChroma )
{
  ...
  else // general resampling process
  {
    ...
    {
      Int x = i;
      refPos16 = Int( ( Int64( x - phaseXL )*scaleX - addX ) >> shiftXM4 ) + refOffsetX;
      phase    = refPos16 & 15;
      refPos   = refPos16 >> 4;
    ...
    {
      Int y = j;
      refPos16 = Int( ( Int64( y - phaseYL )*scaleY - addY ) >> shiftYM4 ) + refOffsetY;
      phase    = refPos16 & 15;
      refPos   = refPos16 >> 4;
  ...
  if( chromaFormatIdc != CHROMA_400 )
  {
    ...
    {
      Int x = i;
      refPos16 = Int( ( Int64( x - srlLOffsetC )*scaleX - addX ) >> shiftXM4 ) + refOffsetXC;
      phase    = refPos16 & 15;
      refPos   = refPos16 >> 4;
      refPos   = Clip3(rlClipL, rlClipR, refPos);
    ...
    {
      Int y = j;
      refPos16 = Int( ( Int64( y - srlTOffsetC )*scaleY - addY ) >> shiftYM4 ) + refOffsetYC;
      phase    = refPos16 & 15;
      refPos   = refPos16 >> 4;
      refPos = Clip3(rlClipT, rlClipB, refPos);
      coeff = m_chromaFilter[phase];
